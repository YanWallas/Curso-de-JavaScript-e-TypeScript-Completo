...
}; // Atraves de tabela ASCII tem os números correspondente a cada letra, números, simbolos e etc.(fromCharCode -> para chamar esse metodo).
...
var simbolos = ',.:~^[]{}!@#$%¨&*()_+=-?\/'; //Jogando os simbolos a mão para const.
var geraSimbolo = function geraSimbolo() {
  return simbolos[rand(0, simbolos.length)];
}; //Gerando o simbolo aleatorio do indice 0 ao tamanho do array
